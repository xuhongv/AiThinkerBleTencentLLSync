...
// define property id
enum {
	BLE_QIOT_PROPERTY_ID_PROPERTY_BOOL,
...
enum {
	...
	BLE_QIOT_PROPERTY_PROPERTY_ENUM_BUTT,
};

// define property_struct mem_int attributes
...
// define property_structmem_string length limit
...
// define property_struct mem_float attributes
...
// define property_struct mem_enum enum
enum {
	...
	BLE_QIOT_STRUCT_PROPERTY_STRUCT_PROPERTY_MEM_ENUM_BUTT,
};

// define property_struct property id
enum {
	BLE_QIOT_STRUCT_PROPERTY_STRUCT_PROPERTY_ID_MEM_BOOL,
