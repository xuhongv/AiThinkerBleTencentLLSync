 ...
 */
 CONST uint8 bleuart_Service2UUID[ATT_UUID_SIZE] =
{0x55, 0xe4,0x05,0xd2,0xaf,0x9f,0xa9,0x8f,0xe5,0x4a,0x7d,0xfe,0x43,0x53,0x53,0x40};
static CONST gattAttrType_t bleuart_Service2 = { ATT_UUID_SIZE, bleuart_Service2UUID };
